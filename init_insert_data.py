...
# 取得供應商CSV檔資料
df = pd.read_csv('instance\供應商.csv', encoding='utf-8')
...
# 取得單位CSV檔資料
df = pd.read_csv('instance\單位.csv', encoding='utf-8')
for index, row in df.iterrows():
    data_set['單位'].append(
        單位(
            代碼=row['代碼'],
...
# 取得幣別CSV檔資料
df = pd.read_csv('instance\幣別.csv', encoding='utf-8')
for index, row in df.iterrows():
    data_set['幣別'].append(
        幣別(
            代號=row['代號'],
...
# 取得員工CSV檔資料
df = pd.read_csv('instance\員工.csv', encoding='utf-8')
for index, row in df.iterrows():
    data_set['員工'].append(
        員工(
            工號簡碼=row['工號簡碼'],
...
# 取得專案CSV檔資料
df = pd.read_csv('instance\專案.csv', encoding='utf-8')
for index, row in df.iterrows():
    data_set['專案'].append(
        專案(
            專案名稱=row['專案名稱'],
...
# 取得捷拓廠區CSV檔資料
df = pd.read_csv('instance\捷拓廠區.csv', encoding='utf-8')
for index, row in df.iterrows():
...
# 取得請購類型CSV檔資料
df = pd.read_csv('instance\請購類型.csv', encoding='utf-8')
for index, row in df.iterrows():
...
# 取得物料類別CSV檔資料
df = pd.read_csv('instance\物料類別.csv', encoding='utf-8')
for index, row in df.iterrows():
